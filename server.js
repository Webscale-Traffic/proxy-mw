...
app.use('/properties/:id', express.static("public"));
...
//   axios
//     .get(`http://184.169.237.98:3003/rooms/${id}/`)
//     .then((data) => {
...
app.get("/properties/:id/reservations", (req, res) => {
  ...
  axios.get(`http://52.53.165.191:6060/properties/${queryParams}/reservations`)
    .then((data) => {
      res.status(200).send(data.data);
    })
    .catch(() => {
...
app.get('/properties/:id/similiar', (req, res) => {
  let id = req.params.id;
  axios.get(`http://54.219.180.82:3004/properties/${id}/similiar`)
    .then((response) => {
